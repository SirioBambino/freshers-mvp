...
This document describes the CI/CD pipeline for the [Cleaner Hire MVP](/README.md). The process ensures that only verified, stable code reaches the production environment.
